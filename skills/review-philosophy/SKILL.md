...
_Check:_ Does this finding have artefact-grounded evidence I could show the author?

### 2. Lower Tier When Uncertain

Severity ties break downward. Confidence is required to inflate; doubt deflates. Floors: BLOCKER requires 90% confidence, IMPORTANT requires 70%, NIT has no minimum.

_Check:_ If I am less than the tier's confidence floor, am I one tier down?
...
_Check:_ If this ships as-is, will it crash, leak, or break a contract? If no, it is not a BLOCKER.

### 4. Scope Discipline

Review the diff and its blast radius, not pre-existing debt.

_Check:_ Did this diff introduce the issue, or is it pre-existing and untouched?

### 5. Pattern Over Taste

Findings cite a violated law, repo convention, or objective standard. "I prefer X" is not a finding.

_Check:_ Can I name the rule this code violates?
