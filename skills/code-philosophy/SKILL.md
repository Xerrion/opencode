...
- NEVER embed external references in code comments — no ADR numbers, ticket IDs, PR or issue-tracker links, author names, or dates. That context lives in version-control history, ADRs, and commit messages; inline references go stale and leak project metadata into source.
